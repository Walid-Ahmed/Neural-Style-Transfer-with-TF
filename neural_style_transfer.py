# USAGE
# python neural_style_transfer.py --image images/baden_baden.jpg --model models/instance_norm/candy.t7
#python neural_style_transfer.py --image images/Milton_Fill_Site_MENKES_CAM_1_2017-11-13_14-40-48.jpg --model models/instance_norm/starry_night.t7
